    ...
    <div className={`flex md:flex-row flex-col items-center justify-center w-full min-h-screen relative md:overflow-y-hidden ${orbitron.className}`}>
       ...
       " >
          ...
          <div className="w-full md:h-[30%] h-[190px] flex justify-between items-center pt-4 ">
            <div className="relative">
              <div className=" md:w-[130px] w-[170px] text-background bg-cyan-400/60 md:h-[150px] h-[170px] rounded-xl flex justify-end items-end overflow-hidden text-sm font-bold px-4 py-2 relative
              [clip-path:path('M_0,20_A_20,20_0,0,1_20,0_L_120,0_A_10,10_0,0,1_130,10_L_130,30_A_10,10_0,0,0_140,40_L_160,40_A_10,10_0,0,1_170,50_L_170,150_A_20,20_0,0,1_150,170_L_20,170_A_20,20_0,0,1_0,150_Z')]
              md:[clip-path:path('M_0,20_A_20,20_0,0,1_20,0_L_80,0_A_10,10_0,0,1_90,10_L_90,30_A_10,10_0,0,0_100,40_L_120,40_A_10,10_0,0,1_130,50_L_130,130_A_20,20_0,0,1_110,150_L_20,150_A_20,20_0,0,1_0,130_L_0,20_Z')]
              ">
            ...
            <div className="relative">
              <div className=" md:w-[130px] w-[170px] text-background bg-violet-700/60 md:h-[150px] h-[170px] rounded-xl flex justify-end items-end overflow-hidden text-sm font-bold px-4 py-2 relative
              [clip-path:path('M_0,20_A_20,20_0,0,1_20,0_L_120,0_A_10,10_0,0,1_130,10_L_130,30_A_10,10_0,0,0_140,40_L_160,40_A_10,10_0,0,1_170,50_L_170,150_A_20,20_0,0,1_150,170_L_20,170_A_20,20_0,0,1_0,150_Z')]
              md:[clip-path:path('M_0,20_A_20,20_0,0,1_20,0_L_80,0_A_10,10_0,0,1_90,10_L_90,30_A_10,10_0,0,0_100,40_L_120,40_A_10,10_0,0,1_130,50_L_130,130_A_20,20_0,0,1_110,150_L_20,150_A_20,20_0,0,1_0,130_L_0,20_Z')]
              ">
      ...
      <div className="relative ">
        ...
        ">
          ...
          <Image src={molekulLine} alt="illustration fitness" width={720} height={570} style={{objectFit: 'cover'}} sizes="(min-width: 1024px) 720px, (min-width: 768px) 480px, 100vw" loading="lazy" className="absolute right-0 md:top-0 bottom-0 md:-translate-y-20 -translate-y-10 md:scale-125 scale-150  invert dark:invert-0 rotate-90" />
          <Image src={illustrationFitness} alt="illustration fitness " width={720} height={570} style={{objectFit: 'cover'}} sizes="(min-width: 1024px) 720px, (min-width: 768px) 480px, 100vw" priority fetchPriority="high"  className="md:scale-65 scale-75 md:translate-x-33 translate-x-16 md:translate-y-5 translate-y-35 hue-rotate-90 "/>
          ...
          {/* <Image src={INI} alt="INI" width={50} height={50} loading="lazy" className="absolute md:top-4 top-40 right-4 invert dark:invert-0"/> */}
        </div>
        <div className="w-[300px] h-[150px] bg-card absolute top-0" style={{
          ...
          <div className="relative w-full h-full">
            <Image src={futuristicIcon} alt="illustration fitness " width={300} height={150} style={{objectFit: 'cover'}} sizes="(min-width: 1024px) 720px, (min-width: 768px) 480px, 100vw" loading="lazy" className="absolute scale-70 rotate-90 -translate-y-20 translate-x-20 "/>
            <Image src={japaneseText} alt="illustration fitness " width={300} height={150} style={{objectFit: 'cover'}} sizes="(min-width: 1024px) 720px, (min-width: 768px) 480px, 100vw" loading="lazy" className="absolute scale-70 -translate-y-17  -translate-x-12 invert dark:invert-0"/>
          </div>
        </div>
      </div>
        <CardMacroWrapper />
